/**
 * It's a jQuery plugin that creates a notification box with a title, message, icon, and close button.
 * @param type - The type of notification. Can be alert, success, error, warning, info.
 * @param title - The title of the notification.
 * @param message - The message you want to display.
 * @param autoHide - true, //true | false
 */
			...
			s = {
				...
				_setContent: function () {
					...
					if (t.message && t.message != null) {
						r.find(t._classes.content).append('<h5>' + t.message + '</h5>');
					}
