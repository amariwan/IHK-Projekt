	...
	var t,
		...
		i = ((t = function(t, e, r, n) {
			...
			if (((n = n || document), (a = Object.create(s)), 'string' == typeof t && (t = n.querySelector(t)), t))
				return (
					(i = n.createElementNS('http://www.w3.org/2000/svg', 'svg')).setAttribute('version', '1.1'),
		...
		(a = function(t, e, r, n, i) {
			...
			return (
				(i = i || document),
				((a = Object.create(o)).el = i.createElementNS('http://www.w3.org/2000/svg', e)),
				a.attr(r),
	...
	return (
		...
		((e = (function() {
			function a(t) {
				...
				if ((_classCallCheck(this, a), 'string' == typeof t && (t = n.querySelector(t)), !t))
					...
					[
						{
							...
							value: function(e, t) {
								...
								if ('object' !== _typeof(e))
									throw new TypeError(
										'Wrong argument passed to attr. Expected object, got "'.concat(_typeof(e), '"')
									);
								return (
									Array.isArray(e) ||
							...
							value: function(t, e) {
								switch (t) {
									...
									case 'animation':
										...
										if ('string' == typeof e && 'none' !== e && !u.easings[e])
											throw new Error(
						...
						},
						{
							...
							value: function() {
								...
								return this._isIndeterminate()
									...
									: 0 === this.max
										? this.value ? 360 : 0
										: ((t = (this.value - this.min) / this.max * 360), Math.min(360, Math.max(0, t)));
							}
						},
						{
						...
						},
						{
							...
							value: function() {
								...
								this._isIndeterminate()
									? 'valueOnCircle' === this.textFormat && this._positionValueText(i)
									: ((t = this._valToAngle(this.value)),
										...
										'none' !== this.animation && t !== this.graph.angle
											...
											: this.graph.sector.attr('d', a._makeSectorPath(50, 50, e, i, t, r)),
										(this.graph.angle = t),
										'valueOnCircle' === this.textFormat && this._positionValueText((2 * i + t) / 2)),
						...
						},
						{
							...
							value: function() {
								return (
									...
									Math.max(
										parseFloat(
											this.doc.defaultView.getComputedStyle(this.graph.circle.el, null)[
												'stroke-width'
											]
										),
										parseFloat(
											this.doc.defaultView.getComputedStyle(this.graph.sector.el, null)[
												'stroke-width'
											]
										)
									) /
