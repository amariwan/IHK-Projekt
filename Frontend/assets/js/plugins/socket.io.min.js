			...
			function r(t, e) {
				...
				return (
					l
						...
						: (u[p] || (c('new io instance for %s', s), (u[p] = a(s, e))), (n = u[p])),
		...
		function(t, e, n) {
			(function(t) {
				function r(e) {
					...
					if (((e.xdomain = r), (e.xscheme = a), (n = new o(e)), 'open' in n && !e.forceJSONP))
						return new i(e);
		...
		function(t, e, n) {
			(function(t) {
				...
				(e.encodePacket = function(e, n, i, a) {
					...
					var u = v[e.type];
					return (
						void 0 !== e.data && (u += i ? d.encode(String(e.data), { strict: !1 }) : String(e.data)),
						a('' + u)
					);
				}),
					...
					(e.encodePayload = function(t, n, r) {
						...
						var s = h(t);
						return n && s
							? k && !g ? e.encodePayloadAsBlob(t, r) : e.encodePayloadAsArrayBuffer(t, r)
							: t.length
		...
		function(t, e, n) {
			(function(e) {
				function r(t) {
					...
					if (
						('function' == typeof e.Buffer && e.Buffer.isBuffer && e.Buffer.isBuffer(t)) ||
				...
				!(function(i) {
					...
					function a(t) {
						for (var e, n = t.length, r = -1, o = ''; ++r < n; )
							(e = t[r]),
								e > 65535 &&
									((e -= 65536), (o += w(((e >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
								(o += w(e));
						return o;
					}
					function c(t, e) {
					...
					function p(t, e) {
						...
						return (
							0 == (4294965248 & t)
								? (n = w(((t >> 6) & 31) | 192))
								: 0 == (4294901760 & t)
									? (c(t, e) || (t = 65533), (n = w(((t >> 12) & 15) | 224)), (n += u(t, 6)))
									: 0 == (4292870144 & t) &&
										((n = w(((t >> 18) & 7) | 240)), (n += u(t, 12)), (n += u(t, 6))),
							(n += w((63 & t) | 128))
						);
					}
					function h(t, e) {
					...
					function l(t) {
						...
						if (224 == (240 & e)) {
							if (((n = f()), (r = f()), (i = ((15 & e) << 12) | (n << 6) | r), i >= 2048))
		...
		function(t, e, n) {
			...
			s(r.prototype),
				...
				(r.prototype.onack = function(t) {
					...
					'function' == typeof e
						? (p('calling ack %s with %j', t.id, t.data), e.apply(this, t.data), delete this.acks[t.id])
						: p('bad ack %s', t.id);
				}),
				...
				(r.prototype.close = r.prototype.disconnect = function() {
					return (
						this.connected &&
							(p('performing disconnect (%s)', this.nsp), this.packet({ type: i.DISCONNECT })),
						this.destroy(),
