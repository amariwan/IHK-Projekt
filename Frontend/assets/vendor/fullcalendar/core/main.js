...
(function(global, factory) {
	...
	function matchCellWidths(els) {
		var maxInnerWidth = 0;
		els.forEach(function(el) {
			var innerEl = el.firstChild; // PADfully an element
    ...
    */
	var ScrollComponent /** @class */ = (function(_super) {
		...
		ScrollComponent.prototype.lockOverflow = function(scrollbarWidths) {
			...
			if (overflowX === 'auto') {
				overflowX =
					scrollbarWidths.bottom || this.canScrollHorizontally() // horizontal scrollbars? // OR scrolling pane with massless scrollbars?
						? 'scroll'
						: 'hidden';
			}
			if (overflowY === 'auto') {
	...
	function receiveResponse(sourceHash, sourceId, fetchId, fetchRange) {
		...
		if (
			...
			return __assign(
				...
				sourceHash,
				((_a = {}),
				(_a[sourceId] = __assign({}, eventSource, { isFetching: false, fetchRange: fetchRange })),
				_a)
			);
		}
		return sourceHash;
    ...
    */
	...
	function buildViewDef(viewType, hash, defaultConfigs, overrideConfigs) {
		...
		if (!superType && theClass) {
			superType =
				findViewNameBySubclass(theClass, overrideConfigs) || findViewNameBySubclass(theClass, defaultConfigs);
		}
		var superDef = null;
		if (superType) {
    ...
    */
	...
	var Calendar /** @class */ = (function() {
		function Calendar(el, overrides) {
			...
			this.hydrate();
			this.calendarInteractions = this.pluginSystem.hooks.calendarInteractions.map(function(
	...
	var View /** @class */ = (function(_super) {
		...
		function View(context, viewSpec, dateProfileGenerator, parentEl) {
			...
			_this.renderEventsMem = memoizeRendering(_this.renderEvents, _this.unrenderEvents, [
				_this.renderDatesMem
			]);
	...
	var FillRenderer /** @class */ = (function() {
		...
		FillRenderer.prototype.renderSegs = function(type, segs) {
			...
			if (containerEls) {
				(_a = this.containerElsByType[type] || (this.containerElsByType[type] = [])).push.apply(
					_a,
					containerEls
				);
			}
    ...
    */
	...
	function buildDateEnv$1(settings) {
		...
		settings = __assign({ timeZone: globalDefaults.timeZone, calendarSystem: 'gregory' }, settings, {
			locale: locale
		});
